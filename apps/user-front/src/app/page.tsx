  ...
  return (
    <>
      <Box mx="auto" mt="10" width="100%" maxWidth="500px">
        ...
        <p>
          <a href="https://github.com/campbel2525/sample-drf-project" target="_blank">
            詳しくはこちら
          </a>
        </p>
      </Box>
      ...
      <Box mx="auto" mt="10" width="100%" maxWidth="500px">
        ...
        <p>
          <Link href={frontPaths.updateEmail} style={{ textDecoration: 'underline' }}>
            update email
          </Link>
        </p>
        <p>
          <Link
            href={frontPaths.updatePassword}
            style={{ textDecoration: 'underline' }}
          >
            update password
          </Link>
        ...
        <p>
          <Link href={frontPaths.resetPassword} style={{ textDecoration: 'underline' }}>
            password reset
          </Link>
        </p>
      </Box>
